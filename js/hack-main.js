...
- Processes input
- Contains the Main Loop that calls update for each manager
- UI stuff for combo and credits
- Physics logic
*/
...
function update(ts) {
  //the main loop that calls update on each manager
  let cts = ts / 1000
  ...
  let currentPosition = sackObject.el.getAttribute('position') //apply Physics to the sack
